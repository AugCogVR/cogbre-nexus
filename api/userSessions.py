...
class UserSession:
    def __init__(self, userId):
        ...
        self.sessionObjects = {}
        self.sessionConfig = { "sessionName" : "unset" }
    ...
    def updateUserSession(self, commandList):
        ...
        if (self.telemetryCsvFile is None):
            ...
            self.telemetryCsvWriter.writerow(["userId", "sessionName", "object", "time", "x", "y", "z", "rotx", "roty", "rotz"])
        self.lastUpdateTime = time.time()

        if (commandList[1] == "object"): 
            objectId = commandList[2]
            self.telemetryCsvWriter.writerow([self.userId, self.sessionConfig["sessionName"], objectId, self.lastUpdateTime, commandList[3], commandList[4], commandList[5], 0, 0, 0])
